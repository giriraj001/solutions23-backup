...
var eventDetails = [
  {
    ...
    time: "To be declared",
    prizeWorth:
      "6000/- <b>(TE/BE LEVEL)</b><br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 5000/-<b>(FE/SE LEVEL)</b>",
    teamSize: " 1",
    descriptionUp:
...

  {
    ...
    paragraph:
      "<i><b>Participants have to register on both the sites i.e our site and coding ninja's site for this event.</b></i>",
    descriptionDown:
      "<b>GUIDELINES:</b> <br>1. Individual Participation<br>2. This round will be for<b> 2hrs</b>.<br>3. 3-4 Problems will be given. <br>4. Platform : <b>CODING NINJA</b>",
  },
...

  {
    ...
    descriptionDown:
      "<b>RULES:</b><br>  Time Duration: <b> 60 Minutes</b>.<br><u>Changes in the pattern can be made with a prior notice.</u><br> Decision of the Judges will be FINAL and non-questionable. ",
  },
...

  {
    ...
    descriptionDown:
      "<b>GAME SETTINGS:</b> <br>1. Game mode : Normal Battle(1v1)<br> 2. Level Cap : 9",
  },
...

  {
    ...
    descriptionUp: "",
    paragraph:
      "<b><u>Guidelines:</u></b><br>1. There will be one round only.<br>2. Individual Participation <br>3. Domain: <b>Quantitative Aptitude, Reasoning, Maths</b>.<br><br> <b>Details :</b> 1. Teams will be given MCQ aptitude questions, <b>30mins </b>will be given forsolving.",
    descriptionDown: "",
  },

  {
    ...
    teamsize: "1",
    descriptionUp:
      " <b>3X3 CUBE WILL BE USED</b><br> Participants can submit any number of videos, best will be considered send your video on: <a style='max-width:-webkit-fill-available;font-size:13px;color:aqua;border:1px solid aqua;padding:8px' href='mailto:aittechboard2020@gmail.com'>aittechboard2020@gmail.com</a> before<b> 24 MAY:</b><br>participants should be clearly visible in the video(not just hands).",
    paragraph:
      "The <b>top 10</b> entries will be considered for the final. Where participants have to solve the cube in front of the camera.<br><b>Online platform will be MS Teams</b>",
    descriptionDown: "",
  },
...

  {
    ...
    teamsize: "1",
    descriptionUp:
      "Participants will be provided an Engineering Drawing of an 3D Object. They have to design a 3D CAD model of that object using SOLIDWORKS Software. ",
    paragraph:
      "<i>The event will be held in 3 Rounds:-</i><br>●	ROUND 1 : Screening Round <br> ●	ROUND 2 : Semi-Finals <br> ●	ROUND 3 : Finals <br> The difficulty level will increase with each round.",
    descriptionDown:
      "RULES:<br> 1.	The criteria for judging are: accuracy, time limit & creativity.  <br>2.	Participants are advised to join 20 minutes prior to start time of the competition. <br>  3.	The decision of the judges shall be final and binding. <br> 4.	In case of any on the spot discrepancy, the decision of the organizer's will be considered final.",
  },
  ...
  },
  {
    ...
    teamsize: "1",
    descriptionUp:
      "<i><b>*only for engineering undergraduates</b></i><br><br>Technical quiz based on engineering subjects and recent technological discoveries.",
    paragraph:
...
// list of events with there own website
let self_website=[
  [ 24 ,"ByPass CTF", "https://solutions22.in/" ],
  [  0 ,"codered", "https://solutions22.in/" ],
  [25 ,"TROUBLESHOOTING THE ENCLOSURE","https://solutions22.in/" ],
  [26,"TECHSTORM", "https://solutions22.in/"]
]
...
window.addEventListener("DOMContentLoaded", function () {
  eventDetails.forEach(function (data) {
    if (data.id === eventId) {
      displayData = `
        ...
        <br>
        <div class="registerForEvent" id="upper" ></div>
          `;
    }
  ...
  // redirecting method
  let registerbtn=document.querySelector("#upper")
  let redirect=false;
  for (let e = 0; e < self_website.length; e++) {
    console.log(self_website[e][0])
    if(eventId==self_website[e][0]){
  ...
  if(!redirect) {
    ...
    registerbtn.innerHTML=`<a class="line-anim" id="register-button-anchor" href="../../google-forms/index.html?eventId=${eventDetails[eventId]["id"]}" >Register for event</a>`;
  }
});
